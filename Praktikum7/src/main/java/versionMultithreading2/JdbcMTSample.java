...
public class JdbcMTSample extends Thread
{
        ...
        try
        {
            ...
            if (share_connection)
                s_conn = DriverManager.getConnection
                        ("jdbc:mysql://192.168.178.103:3306/DBI?rewriteBatchedStatements=true","sam","password");
    ...
    public void run()
    {
        ...
        try
        {
            ...
            {
                conn = DriverManager.getConnection("jdbc:mysql://192.168.178.103:3306/DBI?rewriteBatchedStatements=true","sam","password");
